...
var viz, sheet, workbook; //We need this to be semi-global so we can reference it via multiple functions
    ...
    function initViz()
    {
        var containerDiv = document.getElementById("vizContainer"),
            ...
            url = "https://eu-west-1a.online.tableau.com/t/magalidrumare/views/ProfitLossContrledeGestion/PLKPIs?:showAppBanner=false&:display_count=n&:showVizHome=n&:origin=viz_share_link" //PASTE LINK HERE
            options =
            {
              width: "1100px",
              height: "650px",
